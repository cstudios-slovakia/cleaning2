...
const translations = {
  ...
  sk: {
    ...
    settings: { title: "Nastavenia", subtitle: "Správa preferencií", user_language: "Jazyk užívateľa", system_language: "Predvolený jazyk systému", system_language_help: "Môže nastaviť iba admin. Týka sa užívateľov, ktorí si nezvolili vlastný jazyk.", default: "Predvolené v systéme", profile: "Nastavenia profilu", pin: "Váš PIN" }
  },
  hu: {
    ...
    settings: { title: "Beállítások", subtitle: "Preferenciák kezelése", user_language: "Felhasználó nyelve", system_language: "Rendszer alapértelmezett nyelve", system_language_help: "Csak az adminisztrátor állíthatja be. Azokra a felhasználókra vonatkozik, akik nem választottak saját nyelvet.", default: "Rendszer alapértelmezett", profile: "Profil beállítások", pin: "Az Ön PIN kódja" }
  },
  de: {
    ...
    settings: { title: "Einstellungen", subtitle: "Verwalten Sie Ihre Einstellungen", user_language: "Benutzersprache", system_language: "Standard-Systemsprache", system_language_help: "Kann nur vom Administrator eingestellt werden. Gilt für Benutzer, die keine persönliche Sprache gewählt haben.", default: "Systemstandard", profile: "Profileinstellungen", pin: "Ihre PIN" }
  },
  es: {
    ...
    settings: { title: "Configuraciones", subtitle: "Administrar sus preferencias", user_language: "Idioma del usuario", system_language: "Idioma predeterminado del sistema", system_language_help: "Solo lo puede establecer el administrador. Se aplica a los usuarios que no han seleccionado un idioma personal.", default: "Predeterminado del sistema", profile: "Configuración de perfil", pin: "Su PIN" }
  },
  uk: {
    ...
    settings: { title: "Налаштування", subtitle: "Керування уподобаннями", user_language: "Мова користувача", system_language: "Системна мова за замовчуванням", system_language_help: "Може бути встановлена лише адміністратором. Застосовується до користувачів, які не обрали особисту мову.", default: "За замовчуванням", profile: "Налаштування профілю", pin: "Ваш ПІН-код" }
  },
  ru: {
    ...
    settings: { title: "Настройки", subtitle: "Управление предпочтениями", user_language: "Язык пользователя", system_language: "Системный язык по умолчанию", system_language_help: "Может быть установлен только администратором. Применяется к пользователям, которые не выбрали личный язык.", default: "По умолчанию", profile: "Настройки профиля", pin: "Ваш ПИН-код" }
  }
};
